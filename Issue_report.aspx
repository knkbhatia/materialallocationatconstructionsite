<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Issue_report.aspx.cs" Inherits="Issue_report" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div>
        <h1>
            <asp:Label ID="lblissuehdr" runat="server" Text="Issue Report" CssClass="myPageHeader"></asp:Label></h1>
        <p>
            
            
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="lblissuenosearch" runat="server" Text="Issue number: "
                CssClass="myLabel"></asp:Label>
            &nbsp;
            <asp:TextBox ID="txtissuenosearch" runat="server" MaxLength="20" CssClass="myInput"></asp:TextBox>
            &nbsp;&nbsp;&nbsp;
            ...
            <asp:GridView ID="gvaudit" runat="server" AutoGenerateColumns="False" GridLines="None"
                ...
                <asp:CommandField ShowSelectButton="true" />
                    <asp:TemplateField HeaderText="ISSUE NUMBER">
                        <ItemTemplate>
                            <asp:Label ID="lblissueno" runat="server" Text='<%# bind("ISSUE_NO") %>'>
                            </asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="ISSUE DATE">
                        <ItemTemplate>
                            <asp:Label ID="lblallodate" runat="server" Text='<%# bind("ISSUE_DT") %>'>
                            </asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Wrap="False" Width="150px" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="ALLOCATION NO">
                        <ItemTemplate>
                            <asp:Label ID="lblcontreqno" runat="server" Text='<%# bind("ALLO_NO") %>'>
                            </asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Wrap="False" Width="150px" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="CONTRACTOR REQUEST NO">
                        <ItemTemplate>
                            <asp:Label ID="lblcontcode" runat="server" Text='<%# bind("CONT_REQ_NO") %>'>
                            </asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:ButtonField Text="Items Issued" CommandName="EditJobAct">
    ...
    <asp:HiddenField ID="ISSUENO" runat="server" />
                        ...
                        <table id="Table3" runat="server" width="100%" border="1">
                            <tr>
                                <td align="center" class="myPageHeader">
                                    <h2>
                                        <asp:Label ID="Label16" CssClass="myPageHeader" Text="Items issued" runat="Server" /></h2>
                                </td>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" GridLines="None"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="QUANTITY ISSUED">
                                            <ItemTemplate>
                                                <asp:Label ID="lblqtyreq" runat="server" Text='<%# bind("QTY_ISS") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Right" Wrap="False" Width="150px" />
                                        </asp:TemplateField>
