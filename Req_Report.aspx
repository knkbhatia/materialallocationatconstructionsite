<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Req_Report.aspx.cs" Inherits="Req_Report"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div>
        <h1>
            <asp:Label ID="lblitemreqhdr" runat="server" Text="Item Request Report" CssClass="myPageHeader" ></asp:Label></h1>
        <p>
            ...
            &nbsp;&nbsp;&nbsp;
            <asp:Label ID="lblcontcodesearch" runat="server" Text="Contractor code: " CssClass="myLabel"></asp:Label>
            &nbsp;
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="gvaudit" runat="server" AutoGenerateColumns="False" GridLines="None"
                ...
                <asp:CommandField ShowSelectButton="true" />
                    <asp:TemplateField HeaderText="CONTRACTOR REQUEST NUMBER">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="CONTRACTOR REQUEST DATE">
                        <ItemTemplate>
                            <asp:Label ID="lblcontreqdate" runat="server" Text='<%# bind("CONT_REQ_DATE") %>'>
                            </asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Wrap="False" Width="150px" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="CONTRACTOR NAME">
                        <ItemTemplate>
                            <asp:Label ID="lblcontname" runat="server" Text='<%# bind("CONT_NAME") %>'>
                            </asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:ButtonField Text="Items Requested" CommandName="EditJobAct">
    ...
    <asp:HiddenField ID="REQNO" runat="server" />
                        ...
                        <table id="Table3" runat="server" width="100%" border="1">
                            <tr>
                                <td align="center" class="myPageHeader">
                                    <h2>
                                        <asp:Label ID="Label16" CssClass="myPageHeader" Text="Items requested" runat="Server" /></h2>
                                </td>
